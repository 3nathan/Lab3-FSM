...
VL_ATTR_COLD void Vclktick___024root__trace_init_sub__TOP__0(Vclktick___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+5,"data_out", false,-1, 7,0);
    tracep->declBus(c+8,"current_state", false,-1, 8,0);
    tracep->declBus(c+9,"next_state", false,-1, 8,0);
...
VL_ATTR_COLD void Vclktick___024root__trace_full_sub_0(Vclktick___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+7,(vlSelf->clktick__DOT__tick));
    bufp->fullSData(oldp+8,(vlSelf->clktick__DOT__myF1StateMachine__DOT__current_state),9);
    bufp->fullSData(oldp+9,(vlSelf->clktick__DOT__myF1StateMachine__DOT__next_state),9);
